...
/* Define if we have libiconv support */
/* #undef HAVE_ICONV */
...
/* Define if we have debugging enabled */
#define PI_DEBUG 1
...
/* Define if we have termios(3) support */
#define TERMIOS_CSPEED 1
